...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "Recommended": "Complete your meal",
  ...
  hi: {
    ...
    "Recommended": "अपना भोजन पूरा करें",
  ...
  mr: {
    ...
    todaysSpecial: "आजचे खास",
    chefFavourites: "शेफचे आवडते",
    trendingToday: "आजचे ट्रेंडिंग",
    completeYourMeal: "आपले जेवण पूर्ण करा",
    ...
    "Recommended": "तुमचे जेवण पूर्ण करा",
