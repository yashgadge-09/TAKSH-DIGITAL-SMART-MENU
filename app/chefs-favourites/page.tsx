          ...
          <div className="mx-auto max-w-sm grid grid-cols-[40px_1fr_40px] items-center gap-3">
            ...
            <div className="text-center">
              <h1 className="font-serif text-[20px] leading-none tracking-wide text-[color:var(--brand-gold)]">
                {t("chefFavourites") || "Chef's Favourites"}
              </h1>
      ...
      <div className="mx-auto w-full max-w-sm px-4 pt-6">
        {isLoading ? (
          ...
          <div className="flex flex-col items-center py-20 text-center">
            ...
            <p className="font-serif text-[18px] text-[color:var(--brand-gold)]">No chef's favourites yet</p>
            <p className="mt-1 text-[13px] text-[color:var(--brand-gold-muted)]">Check back soon for our chef's hand-picked dishes!</p>
          </div>
        ) : (
