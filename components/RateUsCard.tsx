...
export function RateUsCard() {
  ...
  return (
    ...
    >
      <div className="relative bg-[#0D0B0A]/95 backdrop-blur-sm rounded-[15px] p-6 flex flex-col gap-4 overflow-hidden">
        {/* Decorative Background Glow */}
        <div className="absolute -right-10 -top-10 w-40 h-40 bg-[#E28B4B]/10 blur-3xl rounded-full group-hover:bg-[#E28B4B]/20 transition-all duration-500" />
        <div className="absolute -left-10 -bottom-10 w-32 h-32 bg-[#E28B4B]/5 blur-2xl rounded-full group-hover:bg-[#E28B4B]/10 transition-all duration-500" />
        
        <div className="flex items-start justify-between relative z-10">
          <div className="flex flex-col gap-1">
            <div className="flex items-center gap-2">
              <span className="w-8 h-[1.5px] bg-[#E28B4B]/60" />
              <span className="text-[#8E7F71] text-[10px] font-bold uppercase tracking-[0.2em]">Customer Feedback</span>
            </div>
            <h2 className="text-[#E7CFA8] font-bold text-2xl drop-shadow-sm mt-1">Review Our Taste</h2>
          </div>
          <div className="w-14 h-14 rounded-2xl bg-white/[0.03] backdrop-blur-md flex items-center justify-center border border-white/10 group-hover:border-[#E28B4B]/50 group-hover:bg-[#E28B4B]/10 transition-all duration-300">
        ...
        <div className="flex flex-col gap-2 relative z-10">
          <div className="flex items-center gap-1.5">
             ...
             <span className="text-[#E7CFA8] text-sm ml-2 font-bold tracking-wide">5.0</span>
        ...
        <div className="flex items-center justify-between mt-2 pt-5 border-t border-white/[0.05] relative z-10">
          <div className="flex items-center gap-2.5 text-[#E7CFA8]/60 text-[11px] font-medium tracking-tight">
            <div className="w-7 h-7 rounded-full bg-[#E28B4B]/10 flex items-center justify-center border border-[#E28B4B]/20">
              <MapPin size={14} className="text-[#E28B4B]" />
            </div>
            <span>TAKSH Veg, Nigdi</span>
          </div>
          <div className="flex items-center gap-2 px-4 py-2 bg-[#E28B4B] text-[#0D0B0A] text-xs font-black rounded-full shadow-[0_4px_15px_rgba(226,139,75,0.3)] group-hover:shadow-[0_4px_25px_rgba(226,139,75,0.5)] group-hover:translate-y-[-1px] transition-all active:translate-y-[0px]">
